...
model_linear <- lm(JobSat ~ Age + YearsCodePro, data = survey_data_selected)
model_quadratic <- lm(JobSat ~ Age + I(Age^2) + YearsCodePro, data = survey_data_selected)
