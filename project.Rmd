...
selected_columns <- c("ResponseId", "Age", "Country", "EdLevel", "Employment", 
                      "DevType", "YearsCodePro", "ConvertedCompYearly", "JobSat")
...
```{r}
# Encoding Employment as binary variable (1 = Full-time, 0 = Others)
survey_data_selected <- survey_data_selected %>%
  mutate(is_employed = ifelse(Employment == "Employed, full-time", 1, 0))
```
